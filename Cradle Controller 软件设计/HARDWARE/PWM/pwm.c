...
{  
   ...
   //设置引脚为复用输出功能,输出TIM2的PWM脉冲波形
	...
	TIM_OCInitStructure.TIM_OCPolarity = TIM_OCPolarity_Low; //输出极性:TIM输出比较极低
  ...
  TIM_CtrlPWMOutputs(TIM2, ENABLE);	//MOE 主输出使能 高级定时器必须带这一句否则无法输出PWM波
